...
var Bebop = module.exports = function(opts) {
  ...
  this.on('BatteryStateChanged', function () {
  ...
  this.on('takingOff', function () {
    this.navData.flyingState = { takingOff: true };
    this.emit('navData', this.navData);
  })

  this.on('hovering', function () {
    this.navData.flyingState = { hovering: true };
    this.emit('navData', this.navData);
  })

  this.on('flying', function () {
    this.navData.flyingState = { flying: true };
    this.emit('navData', this.navData);
  })

  this.on('landing', function () {
    this.navData.flyingState = { landing: true };
    this.emit('navData', this.navData);
  })

  this.on('emergency', function () {
    this.navData.flyingState = { landing: true };
    this.emit('navData', this.navData);
  })
  
  this.on('PositionChanged', function (position) {
    this.navData.position = position;
    this.emit('navData', this.navData);
  })

  this.on('AltitudeChanged', function (altitude) {
    this.navData.altitude = altitude;
    this.emit('navData', this.navData);
  })

  this.on('AttitudeChanged', function (attitude) {
    this.navData.attitude = attitude;
    this.emit('navData', this.navData);
  })
